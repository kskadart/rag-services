...
class EmbeddingService:
    ...
    def load_model(self) -> None:
        ...
        if self.model is None:
            ...
            with torch.no_grad():
                ...
                # Use mean pooling of last state
    ...
    def embed_text(self, text: str, max_length: int, normalize: bool, pooling_strategy: str) -> List[float]:
        """
    ...
    def embed_batch(
        self, texts: List[str], batch_size: int, max_length: int, normalize: bool, pooling_strategy: str
    ) -> List[List[float]]:
        """
